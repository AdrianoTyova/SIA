import { getCurrentInstance as getCurrentInstance$1, version as version$1, createVNode, mergeProps, toRefs, Transition, ref, computed, watch, nextTick, toRef, Text, watchEffect, provide, onScopeDispose, withDirectives, vShow, resolveDirective, reactive, inject as inject$1, capitalize, h, defineComponent as defineComponent$1, Suspense, shallowRef, isReadonly, camelize, unref, isRef, toRaw, readonly, TransitionGroup, Fragment as Fragment$1, resolveDynamicComponent, cloneVNode, effectScope, warn, toHandlers, Teleport, createTextVNode, vModelText, useSSRContext, createApp, onErrorCaptured, onServerPrefetch, defineAsyncComponent, withCtx } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-c48df61d.mjs').then((m) => m.default || m)
  },
  {
    name: "plantacao",
    path: "/plantacao",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-ba5ba5ef.mjs').then((m) => m.default || m)
  },
  {
    name: "plantacao-selecao",
    path: "/plantacao/selecao",
    children: [],
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/selecao-126a9c4a.mjs').then((m) => m.default || m)
  },
  {
    name: "processos",
    path: "/processos",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-fdfaae05.mjs').then((m) => m.default || m)
  },
  {
    name: "vendas-empresas",
    path: "/vendas/empresas",
    children: [],
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/empresas-054db40c.mjs').then((m) => m.default || m)
  },
  {
    name: "vendas-provincias",
    path: "/vendas/provincias",
    children: [],
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/provincias-9b4c32cc.mjs').then((m) => m.default || m)
  }
];
...
const vuetify_7h9QAQEssH = defineNuxtPlugin((nuxt) => {
...
const layouts = {
  default: () => import('./_nuxt/default-fa694a9a.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-d4e8a79d.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, __nuxt_component_1 as a, useNuxtApp as b, createError as c, entry$1 as default, navigateTo as n, useRouter$1 as u };
