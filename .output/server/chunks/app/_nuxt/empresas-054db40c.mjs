...
import { useSSRContext, resolveComponent, withCtx, createTextVNode, toDisplayString, createVNode, withDirectives, vShow, mergeProps, openBlock, createBlock, Fragment, renderList } from 'vue';
                            ...
                            createVNode("div", { class: "PaiImg d-flex justify-space-between flex-column pa-0" }, [
                              ...
                              createVNode("div", { class: "legendaProdutoModal pa-5" }, [
                                createVNode("div", null, [
                                  ...
                                  createVNode("p", { class: "text-grey-darken-2 text-center" }, "Pre\xE7o da Cebola: 20.000Kz - 100Kg")
                                ]),
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    ...
                    _push4(ssrRenderComponent(_component_v_card_text, { class: "pa-0" }, {
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          _push5(`<div class="PaiImg d-flex justify-space-between flex-column pa-0" data-v-00893f79${_scopeId4}><div class="legendaProdutoModal pa-5" data-v-00893f79${_scopeId4}><div data-v-00893f79${_scopeId4}><p class="text-center" data-v-00893f79${_scopeId4}>Esta \xE9 a lista de transporte ideal para a sua mercadoria</p></div><div class="produtosAvo d-flex justify-center align-center" data-v-00893f79${_scopeId4}><div class="produtosPai pt-8" data-v-00893f79${_scopeId4}><!--[-->`);
                          ...
                          return [
                            createVNode("div", { class: "PaiImg d-flex justify-space-between flex-column pa-0" }, [
                              createVNode("div", { class: "legendaProdutoModal pa-5" }, [
                                createVNode("div", null, [
                                  createVNode("p", { class: "text-center" }, "Esta \xE9 a lista de transporte ideal para a sua mercadoria")
                                ]),
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(ssrRenderComponent(_component_v_card_text, { class: "pa-0" }, {
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          _push5(`<div class="PaiImg d-flex justify-space-between flex-column pa-0" data-v-6492006e${_scopeId4}><div class="imgProdutoModal" data-v-6492006e${_scopeId4}></div><div class="legendaProdutoModal pa-5" data-v-6492006e${_scopeId4}><div data-v-6492006e${_scopeId4}><h1 class="text-green text-center" data-v-6492006e${_scopeId4}>Venda de cebola para a empresa</h1><p class="text-center" data-v-6492006e${_scopeId4}>De Hu\xEDla para Luanda</p><p class="text-grey-darken-2 text-center" data-v-6492006e${_scopeId4}>Pre\xE7o da Cebola: 20.000Kz - 20Kg</p><p class="text-grey-darken-2 text-center" data-v-6492006e${_scopeId4}>Qtd: - 1 + </p><p class="text-grey-darken-2 text-center" data-v-6492006e${_scopeId4}>Total a vender: 150.000Kz - 500Kg </p></div>`);
                            ...
                            createVNode("div", { class: "PaiImg d-flex justify-space-between flex-column pa-0" }, [
                              ...
                              createVNode("div", { class: "legendaProdutoModal pa-5" }, [
                                createVNode("div", null, [
                                  ...
                                  createVNode("p", { class: "text-center" }, "De Hu\xEDla para Luanda"),
                                  createVNode("p", { class: "text-grey-darken-2 text-center" }, "Pre\xE7o da Cebola: 20.000Kz - 20Kg"),
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(ssrRenderComponent(_component_v_card_text, { class: "pa-0" }, {
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          _push5(`<div class="PaiImg d-flex justify-space-between flex-column pa-0" data-v-da6f1b2b${_scopeId4}><div class="pImg" data-v-da6f1b2b${_scopeId4}><div class="imgProduto" data-v-da6f1b2b${_scopeId4}></div><div class="imgProdutoModal" style="${ssrRenderStyle($options.verImg())}" data-v-da6f1b2b${_scopeId4}></div></div><div class="legendaProdutoModal pa-5" data-v-da6f1b2b${_scopeId4}><div data-v-da6f1b2b${_scopeId4}><h1 class="text-green text-center" data-v-da6f1b2b${_scopeId4}>Venda de cebola para a empresa ${ssrInterpolate($props.empresa.descricao)}</h1><p class="text-center" data-v-da6f1b2b${_scopeId4}>De Hu\xEDla para Luanda</p><p class="text-grey-darken-2 text-center" data-v-da6f1b2b${_scopeId4}>Pre\xE7o da Cebola: 20.000Kz - 20Kg</p><p class="text-grey-darken-2 text-center" data-v-da6f1b2b${_scopeId4}>Qtd: - 1 + </p><p class="text-grey-darken-2 text-center" data-v-da6f1b2b${_scopeId4}>Total a vender: 150.000Kz - 500Kg </p></div>`);
                          _push5(ssrRenderComponent(_component_ModalSolicitarTransporte, null, null, _parent5, _scopeId4));
                          _push5(`</div></div>`);
                        } else {
                          return [
            ...
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                ...
                _push3(ssrRenderComponent(_component_v_card_text, null, {
                  default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                    if (_push4) {
                      _push4(` A cebola valorizou 15% em 3 dias o pre\xE7o atual de 20Kg \xE9: 30.000kz `);
                    } else {
                      return [
                        createTextVNode(" A cebola valorizou 15% em 3 dias o pre\xE7o atual de 20Kg \xE9: 30.000kz ")
                      ];
                    }
                  }),
                  _: 2
...
//# sourceMappingURL=empresas-054db40c.mjs.map
